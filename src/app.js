                    ...
                    $.ajax({
                        ...
                        success: function(data, status, o) {
                            if (data.success == "email sent") {
                                $(rForm).parents('.modal-body').html('<p>Wonderful! Thank you for reaching out, we will get in contact with you very soon.</p><img src="http://i.giphy.com/10bHcDcPM925ry.gif" alt="" />');
                            } else {
